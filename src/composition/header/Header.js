            ...
            <NavLink to={'/begrepskatalogen'} className="headerLogo__logosvg">
              <svg xmlns="http://www.w3.org/2000/svg" className="navLogo" width="90" viewBox="0 0 269 169">
                ...
                <g fill="none" fillRule="evenodd">
                  <path fill="#C30000"
                        d="M125.31 168.942c-46.642 0-84.46-37.817-84.46-84.465C40.85 37.824 78.667 0 125.31 0c46.657 0 84.48 37.824 84.48 84.477 0 46.648-37.823 84.465-84.48 84.465zM0 121.359l17.265-42.73h16.589l-17.243 42.73zM213.044 121.359l17.044-42.73h9.044l-17.043 42.73z"></path>
